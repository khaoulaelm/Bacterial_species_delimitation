...
# Define paths
base_dir = os.path.expanduser("~/Bacterial_species_delimitation/3_species_delimitation_methods/4_CGCD_approach")
partition_dir = os.path.join(base_dir, "ASAP_partition_matrices")  # Directory with partition matrices (successful genes)
strains_file = os.path.expanduser("~/Bacterial_species_delimitation/1_bacterial_strains/strains.txt")  # File with strains
output_dir = os.path.join(base_dir, "ASAP_conspecificity_matrix")
